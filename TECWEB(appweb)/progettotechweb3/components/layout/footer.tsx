  ...
  return (
    <div className="flex max-w-7xl mx-auto p-8">
      ...
      <footer className="w-full body-font">
        <div
          className="container flex flex-col flex-wrap px-5 py-8 mx-auto md:items-center lg:items-start lg:flex-row lg:flex-no-wrap">
        ...
        <div>
          <div className="flex-wrap w-full px-5 py-4 mx-auto text-center">
