...
namespace lasd
{
  ...
  public:
    ...
    StackVec(const TraversableContainer<Data> &con) : Vector<Data>(con), index(size){};    // A stack obtained from a TraversableContainer
    StackVec(MappableContainer<Data> &&con) : Vector<Data>(std::move(con)), index(size){}; // A stack obtained from a MappableContainer
